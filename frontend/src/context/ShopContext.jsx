...
const ShopContextProvider=(props)=>{
    ...
    const getDeliveryFee = () => {
        ...
        if (cartTotal === 0) return 0;          // empty cart
        if (cartTotal <= 20) return 0;          // small orders: free
        if (cartTotal <= 50) return 3;          // medium orders
        if (cartTotal <= 100) return 5;         // large orders
        return 10;                               // premium orders: free
    };
    ...
    const value={
         ...
         addToCart,getCartAmount,updateQuantity,navigate,
         token,setToken,setCartItems,getCartCount,getDeliveryFee
    }
    return(
